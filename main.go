...
func main() {
	...
	// adminPort := flag.String("admin_port", "3306", "admin manage db port")
	// adminUser := flag.String("admin_user", "", "admin manage db user")
	// adminPass := flag.String("admin_pass", "", "admin manage db password")
	srcDbUser := flag.String("src_db_user", "", "sync source db user")
